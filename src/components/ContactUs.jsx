...
const ContactUs = () => {
  return (
    <>
      ...
      <section>
        <div className="min-h-screen py-6 flex flex-col justify-center sm:py-12 relative" style={{ backgroundImage: `url('${picPQRS}')`, backgroundPosition: "center", backgroundSize: "cover" }}>
