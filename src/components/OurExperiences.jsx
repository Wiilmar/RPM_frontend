            ...
            <div id="experiencias" className="relative items-center w-full px-5 py-7 mx-auto md:px-12 lg:px-24 max-w-7xl pb-20">
                ...
                <div className="grid w-full grid-cols-1 gap-12 mx-auto lg:grid-cols-3">
                    ...
                    <div className="p-6">
                        ...
                        <p className="mx-auto text-xl leading-relaxed text-gray-500 text-justify">Fue mi compañero constante en mi travesía en moto. Me mantuvo en el camino correcto, me alertó sobre condiciones peligrosas y me ayudó a encontrar los mejores lugares para descansar y disfrutar del paisaje. ¡Una aplicación imprescindible para cualquier motoviajero aventurero!</p>
                    </div>
                    <div className="p-6">
                        ...
                        <p className="mx-auto text-xl leading-relaxed text-gray-500 text-justify">Con su ayuda, pude planificar rutas emocionantes y seguras, encontrar alojamiento y restaurantes de calidad, y disfrutar al máximo de cada destino. ¡Recomendaría esta aplicación a cualquier motoviajero que quiera una experiencia inolvidable!</p>
                    </div>
                </div>
            </div>
        </section>
