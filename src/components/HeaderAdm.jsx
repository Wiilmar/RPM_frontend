...
const HeaderAdm = () => {
  ...
  return (
    <div className={`min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased ${isDark ? 'dark' : ''}`}>
      {/* Header */}
        ...
        <div className="flex justify-between items-center h-14 bg-blue-800 dark:bg-gray-800 header-right">
          ...
          <ul className="flex items-center">
            <li>
              ...
              >
                <svg
                  className={`fill-current text-gray-700 group-hover:text-gray-500 group-focus:text-gray-700 ${isDark ? 'dark:text-gray-700 dark:group-hover:text-gray-500 dark:group-focus:text-gray-700' : ''}`}
                  width="24"
                  height="24"
