            ...
            <div className="relative items-center w-full px-5 py-10 mx-auto md:px-12 lg:px-24 max-w-7xl">
                ...
                <div className="grid w-full grid-cols-1 gap-12 mx-auto lg:grid-cols-3">
                    <div className="p-6">
                        ...
                        <h2 className="mx-auto py-4 text-2xl font-medium leading-none tracking-tighter text-neutral-600 lg:text-3xl">Jack Ryder</h2>
                    ...
                    <div className="p-6">
                        ...
                        <h2 className="mx-auto py-4 text-2xl font-medium leading-none tracking-tighter text-neutral-600 lg:text-3xl">Alexander Kornovich</h2>
